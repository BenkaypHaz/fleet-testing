...
namespace Service.Customers.Controllers
{
    ...
    public class SettingFreightPricingPerCustomerController : BaseController
    {
        ...
        public async Task<ActionResult<GenericResponseHandler<FreightPricingSuggestedPriceReadDto>>> GetSuggestedPrice([FromQuery] long customerId, [FromQuery] long warehouseId, [FromQuery] long dispatchBranchId)
        {
