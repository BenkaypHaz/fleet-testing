...
public partial class BusinessProviderProfileContactPerson
{
    public long Id { get; set; }

    public long BusinessProviderProfileId { get; set; }

    public long BusinessPositionTypeId { get; set; }
    ...
    public virtual BusinessPositionType BusinessPositionType { get; set; } = null!;
