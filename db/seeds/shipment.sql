...
-- DROP TABLE shipment.shipment_project_contract_transport_units;
CREATE TABLE shipment.shipment_project_contract_transport_units (
    ...
    rotulation_number VARCHAR(100) NOT NULL,
    created_by BIGINT NOT NULL,
    created_date TIMESTAMP NOT NULL,
    modified_by BIGINT,
    modified_date TIMESTAMP,
    is_active BOOLEAN NOT NULL,
    CONSTRAINT pk_shipment_project_contract_transport_units_id PRIMARY KEY (id),
    CONSTRAINT fk_shipment_project_contract_transport_units_project_contract FOREIGN KEY (shipment_project_contract_id) REFERENCES shipment.shipment_project_contract(id),
    CONSTRAINT fk_shipment_project_contract_transport_units_vehicle FOREIGN KEY (business_partner_transport_vehicle_id) REFERENCES business_partner.business_partner_provider_transport_vehicle(id),
    CONSTRAINT fk_shipment_project_contract_transport_units_rotulation_type FOREIGN KEY (shipment_rotulation_type_id) REFERENCES shipment.shipment_rotulation_type(id),
    CONSTRAINT fk_shipment_project_contract_transport_units_gps_device FOREIGN KEY (shipment_gps_device_id) REFERENCES shipment.shipment_gps_device(id),
    CONSTRAINT fk_shipment_project_contract_transport_units_created_by FOREIGN KEY (created_by) REFERENCES auth.auth_user(id),
    CONSTRAINT fk_shipment_project_contract_transport_units_modified_by FOREIGN KEY (modified_by) REFERENCES auth.auth_user(id)
);
